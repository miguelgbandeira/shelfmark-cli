...
export function formatBytes(sizeStr: string | number): string {
...
export function displaySearchResults(results: SearchResult[], total?: number): void {
  if (results.length === 0) {
...
export function displayReleases(releases: Release[]): void {
